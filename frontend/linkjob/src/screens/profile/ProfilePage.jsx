  ...
  return (
    <div className="min-h-screen py-8">
      <div className="container mx-auto py-8">
        {/* Status Message */}
        {userInfo?.worker ? (
  <div className={`p-4 mb-6 text-white rounded-lg ${userInfo.worker.is_active ? '' : 'bg-red-900'}`}>
    {!userInfo.worker.is_active && (
      <div className="text-center">
        <h2 className="text-lg font-semibold">Account Not Activated</h2>
        <p>
          Your account has been created, but it has not been activated yet. You can check and update your worker info while it's being checked, but your profile will not be showing in the providers list!
        </p>
      </div>
    )}
  </div>
          ...
          <div className="col-span-1 sm:col-span-3">
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <div className="flex flex-col">
                ...
                {userInfo.worker?.categories && userInfo.worker.categories.length > 0 ? (
          ...
          <div className="col-span-1 sm:col-span-9">
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  userInfo.worker.extra_images.length > 0 ? (
                    ...
                    <p className="text-gray-700">No extra images available.</p>
                  )}
                </div>
              </div>
              ...
              <div className="mt-8">
                  ...
                  {userInfo?.worker && userInfo?.worker?.reviews && Array.isArray(userInfo?.worker?.reviews) ? (
